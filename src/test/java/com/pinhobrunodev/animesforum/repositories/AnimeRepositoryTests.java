...
public class AnimeRepositoryTests {
    ...
    public void findByIdShouldReturnOptionalObjectWhenExistsId(){
        Optional<Anime> result = animeRepository.findById(existingId);
    ...
    public void findByIdShouldReturnEmptyOptionalObjectWhenNonExistsId(){
        Optional<Anime> result = animeRepository.findById(nonExistingId);
    ...
    public void saveShouldPersistWithAutoIncrementWhenIdIsNull(){
        Anime anime = Factory.createAnime();
        anime.setId(null);
        animeRepository.save(anime);
        Assertions.assertEquals(countTotalAnimes+1L,anime.getId());
    }
    ...
    public void deleteShouldDeleteObjectWhenExistsId(){
        animeRepository.deleteById(existingId);
        Optional<Anime> result = animeRepository.findById(1L);
    ...
    public void deleteShouldThrowEmptyResultDataAccessExceptionWhenIdDoesNotExists(){
        Assertions.assertThrows(EmptyResultDataAccessException.class,()->{
            animeRepository.deleteById(nonExistingId);
        });
    }
